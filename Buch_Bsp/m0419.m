%  m0419.m    (Für MATLAB/SIMULINK R2007b)
%
%  PID-Regler und P-T1-Strecke
%
%  Bild 4.19
...
clear
    ...
    KprWerte=[ 4    18  ];     % KprWerte=[ 4   18 ] 

    TnWerte=[  2   .9  ];      % TnWerte=[ 2   .9 ] 
...
set(gcf,'Units','normal','Position',[.5 .4 .48 .4], ...
    ...
    'Name',' Bild 4.19: Realer PID-Regler und P-T1-Strecke');

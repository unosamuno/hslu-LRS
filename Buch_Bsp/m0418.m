%  m0418.m    (Für MATLAB/SIMULINK R2007b)
%
%  PID-Regler: Sprungantwort 
%
%  Bild 4.18
...
%
%    Tn   Nachstellzeit im Bereich 1 < Tn < 1000 ("unendlich") 
%
%    Tv   Vorhaltzeit im Bereich  .1  < Tv <  10 ,
%
%    T1D  Zeitkonstante D-Anteil im Bereich .01*Tv  < T1D <  .1*Tv 
%
...
set(gcf,'Units','normal','Position',[.5 .4 .48 .33], ...
    ...
    'Name',' Bild 4.18: Idealer und realer PID-Regler');

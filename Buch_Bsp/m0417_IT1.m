%  m0417_IT1.m    (Für MATLAB/SIMULINK R2007b)
%
%  PD-Regler und I-T1-Strecke Gs=1/s/(2*s+1)
%
%  Abschn. 4.2.4 
...
clear
    ...
    KprWerte=[ 1   1 ];     % KprWerte=[ 4   1.   ] 

    TvWerte=[  0   2  ];    % TvWerte=[.3] 
...
t0A=0;   % Beginn der t-Achse in den Grafiken
...
set(gcf,'Units','normal','Position',[.5 .4 .48 .4], ...
    ...
    'Name',' Abschn. 4.2.4: PD-Regler und I-T1-Strecke (gestrichelt: P-Regler)');
